...
class MallUserServiceTest {
    ...
    @Test
    void register() {
        String register = mallUserService.register("17327711875", "123123");
        log.info(register);
    ...
    @Test
    void login() {
        String login = mallUserService.login("17327711875", "4297f44b13955235245b2497399d7a93");
    ...
    @Test
    void logout() {
        //会在tb_mall_user_token表中删掉10号用户的一条token数
